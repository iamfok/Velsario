    ...
    <>
      ...
      {settings.announcementEnabled &&
        settings.announcementText && (
          ...
          <div className="fixed top-0 left-0 right-0 z-[60] bg-v-black text-v-white text-center py-2 px-4">
            ...
            >
              ...
              settings.logo ? (
                ...
                <img
                  ...
                  className="max-h-10 md:max-h-12 max-w-[150px] md:max-w-[190px] object-contain"
                />
