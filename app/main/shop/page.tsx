    ...
    if (selectedCategory) {
      result = result.filter(
        p =>
          ...
          `velsario-${p.category}` === selectedCategory ||
        ...
        <div className="flex gap-8">
          ...
          <aside className="hidden md:block w-56 flex-shrink-0">
            ...
            <div className="sticky top-28">
              ...
              {/* Category */}
              <div className="mb-8">
                <p className="text-xs tracking-widest uppercase mb-4 font-medium">
                  Category
                </p>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <button
                    ...
                    className={`text-left text-sm py-1 transition-colors ${
                      !selectedCategory
                        ? 'font-medium'
                        : 'text-v-gray hover:text-v-black'
                    }`}
                  >
                    All
                  </button>
              ...
              {(selectedCategory || selectedColor) && (
                <button
                  ...
                  className="flex items-center gap-2 text-xs text-v-gray hover:text-v-black transition-colors"
                >
                  <X size={12} />
                  Clear filters
                </button>
