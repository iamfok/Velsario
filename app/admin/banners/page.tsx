...
export default function BannersPage() {
  ...
  const selectMedia = (item: MediaItem) => {
    ...
    if (
      mediaTarget === 'desktopImage' ||
      mediaTarget === 'mobileImage'
    ) {
      if (item.type !== 'Image') {
  ...
  const toggleStatus = (id: string) => {
    const updated: Banner[] = banners.map(
      (banner): Banner =>
        banner.id === id
          ? {
              ...banner,
                  ...
                  {editing[key] ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className="flex min-h-32 w-full flex-col items-center justify-center border border-v-border bg-v-light text-center transition-colors hover:bg-gray-200"
                      >
                        <ImageIcon
                          size={20}
                          className="mb-2 text-v-gray"
                        />
              ...
              <div className="flex max-h-[90vh] w-full max-w-5xl flex-col bg-white">
                ...
                <div className="border-t border-v-border p-4">
                  ...
                  <button
                    ...
                    className="text-[10px] uppercase tracking-widest text-v-gray underline"
                  >
                    Refresh Media
                  </button>
